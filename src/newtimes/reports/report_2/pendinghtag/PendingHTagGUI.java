...
public class PendingHTagGUI extends JPanel {
  ...
  void jbInit() throws Exception {
    this.setMaxLength();
    jLabel10.setBounds(new Rectangle(197, 124, 170, 20));
    ...
    txtYear.setBounds(new Rectangle(369, 124, 98, 20));
    ...
    jLabel110.setBounds(new Rectangle(197, 46, 170, 20));
    jLabel22.setBounds(new Rectangle(197, 242, 170, 20));
    ...
    cmboCen.setBounds(new Rectangle(369, 46, 209, 20));
    ...
    jLabel7.setBounds(new Rectangle(197, 163, 170, 20));
    jLabel1.setForeground(new Color(143, 143, 188));
    jLabel1.setText("( Year )");
    jLabel1.setBounds(new Rectangle(475, 124, 77, 20));
    cmboDiv.setBounds(new Rectangle(369, 163, 209, 20));
    cmboDiv.setBackground(Color.white);
    cmboSea.setBounds(new Rectangle(369, 242, 209, 20));
    cmboSea.setBackground(Color.white);
    cmboDep.setBounds(new Rectangle(369, 85, 209, 20));
    cmboDep.setBackground(Color.white);
    jLabel19.setBounds(new Rectangle(197, 203, 170, 20));
    ...
    jLabel1112.setBounds(new Rectangle(197, 85, 170, 20));
    popMaker.setBounds(new Rectangle(369, 203, 209, 20));
    this.setLayout(null);

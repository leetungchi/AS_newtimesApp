package newtimes.reports.report01;
...
public class repMessage extends JDialog {
  ...
  public repMessage(Frame frame, String title, String Message, boolean modal) {
...
class mtrWarnDialog_jButton1_actionAdapter implements java.awt.event.ActionListener {
  ...
  mtrWarnDialog_jButton1_actionAdapter(repMessage adaptee) {

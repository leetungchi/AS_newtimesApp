package newtimes.reports.report01.CMTList;
...
public class RepCmtListCon extends JPanel {
  ...
  public RepCmtListCon(Frame1 _frame) {
    frame = _frame;
    try {
  ...
  void jbInit() throws Exception {
    ...
    jLabel1.setText("      ============  CMT LIST REPORT  ============      ");
    ...
    btnExit.setBounds(new Rectangle(428, 447, 80, 25));
    ...
    btnPrint.setBounds(new Rectangle(282, 447, 80, 25));
    ...
    lblQuota.setBounds(new Rectangle(223, 394, 112, 25));
    rbtnUSA.setBackground(new Color(204, 204, 225));
    rbtnUSA.setFont(new java.awt.Font("Dialog", 1, 12));
    rbtnUSA.setFocusPainted(true);
    rbtnUSA.setText("USA");
    rbtnUSA.setBounds(new Rectangle(346, 393, 59, 26));
    rbtnCDA.setBounds(new Rectangle(412, 393, 57, 26));
    rbtnCDA.setText("CDA");
    ...
    rbtnALL.setBounds(new Rectangle(478, 393, 72, 26));
    jLabel9.setBounds(new Rectangle(223, 356, 59, 20));
    jLabel9.setText("RANGE:");
    jLabel9.setFont(new java.awt.Font("Dialog", 1, 12));
    jLabel9.setForeground(new Color(10,36,106));
    tfRange.setText("");
    tfRange.setBounds(new Rectangle(346, 357, 177, 22));
    popMaker.setBounds(new Rectangle(346, 247, 224, 22));
  ...
  void btnPrint_actionPerformed(ActionEvent e) {
    try {
      ...
      frame.showPanel(new newtimes.reports.report01.CMTList.CmtListReport(frame, condHm));

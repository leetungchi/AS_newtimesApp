...
public class CmtListReport extends ScrollPaneGUI {
  Frame1 frame;
  private String titleName = "CMT List Report";
  private java.util.HashMap condHm = new java.util.HashMap();

  public CmtListReport(Frame1 _frame, java.util.HashMap _hm) {
    frame = _frame;
    condHm = _hm;
    try {
      jbInit();
  ...
  void jbInit() throws Exception {
    ...
    this.setScrollPaneGUI(new exgui2.ReportGenerate("CMT_LIST.rpt", this.setReportAgument()));
  ...
  public void do_Exit() {
    frame.showPanel((RepCmtListCon)util.ApplicationProperites.getProperties("RepCmtListCon"));
  }
  ...
  public void do_Print() {
    try {
      ...
      setScrollPaneGUI(new exgui2.ReportGenerate("CMT_LIST.rpt", this.setReportAgument()));
  ...
  private String setReportAgument() {
    try {
      ...
      sb.append("&prompt7="+condHm.get("range"));

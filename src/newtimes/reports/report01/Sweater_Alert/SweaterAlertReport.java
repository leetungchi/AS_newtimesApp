...
public class SweaterAlertReport extends ScrollPaneGUI {
  Frame1 frame;
  private String titleName = "Sweater Alert Report";
  private java.util.HashMap condHm = new java.util.HashMap();

  public SweaterAlertReport(Frame1 _frame, java.util.HashMap _hm) {
    frame = _frame;
    condHm = _hm;
    try {
      jbInit();
  ...
  void jbInit() throws Exception {
    ...
    this.setScrollPaneGUI(new exgui2.ReportGenerate("SWEATER_PPS_ALERT.rpt", this.setReportAgument()));
  ...
  public void do_Exit() {
    //frame.showPanel(new newtimes.reports.report01.Sweater_Alert.RepSweaterAlertCon(frame));
    frame.showPanel((RepSweaterAlertCon)util.ApplicationProperites.getProperties("RepSweaterAlertCon"));
  }
  ...
  public void do_Print() {
    try {
      ...
      setScrollPaneGUI(new exgui2.ReportGenerate("SWEATER_PPS_ALERT.rpt", this.setReportAgument()));
  ...
  private String setReportAgument() {
    try {
      ...
      sb.append("&prompt7="+condHm.get("days"));

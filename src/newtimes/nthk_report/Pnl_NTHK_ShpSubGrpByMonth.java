 ...
 * @version 1.0
 */
public class Pnl_NTHK_ShpSubGrpByMonth
  ...
  public Pnl_NTHK_ShpSubGrpByMonth() {
    try {
  ...
  protected  void genDataBindObj(){
    ...
    /*  DataBindTextWithChecker etdDate = new DataBindTextWithChecker(txtETD, "",
      ...
      reportName="HK_SUBGRP_MONTH.rpt";
    }catch(Exception exp){
       exp.printStackTrace();
    }
  }
 ...
 public void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("NTHK SHIPPING AMOUNT (SUB GROUP)");
    blueBkgWhiteCharLabel1.setBounds(new Rectangle(0, 20, 799, 30));
    this.setLayout(null);
    jLabel1.setText("From ETD (YYYYMM) :");
    jLabel1.setBounds(new Rectangle(12, 66, 163, 23));
    txtETD.setToolTipText("YYYYMM");
    txtETD.setText("");
    txtETD.setBounds(new Rectangle(172, 66, 149, 24));
    jLabel2.setText("CENTER:");
    jLabel2.setBounds(new Rectangle(429, 64, 60, 24));
    cbxCenter.setBounds(new Rectangle(493, 63, 131, 25));
    ...
    txtETDTo.setToolTipText("YYYYMM");
    txtETDTo.setBounds(new Rectangle(172, 100, 149, 24));
    jLabel3.setBounds(new Rectangle(12, 100, 156, 23));

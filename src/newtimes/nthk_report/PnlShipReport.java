...
public class PnlShipReport
  ...
  exgui.ultratable.Wraper4tblCbx[] itemOfSortBy=new exgui.ultratable.Wraper4tblCbx[5];

  protected   DataBindTextWithChecker dbTxtDateBgn,dbTxtDateEnd,dbTwdChg,dbHkdChg,dbRmbChg;

  public PnlShipReport() {
    try {
        ...
        itemOfSortBy[4]=new exgui.ultratable.Wraper4tblCbx();
        ...
        itemOfSortBy[4].setValue("E");itemOfSortBy[4].setString("DEPARTMENT+COUNTRY+FACTORY");
      //jbInit();
    }
    catch(Exception ex) {
      ex.printStackTrace();
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("SHIPMENT  REPORT");
    ...
    jLabel3.setBounds(new Rectangle(41, 98, 68, 24));
    jLabel3.setText("SORT BY:");
    cbxSortBy.setBounds(new Rectangle(113, 97, 383, 25));
  ...
  void btnQry_actionPerformed(ActionEvent e) {
    ...
    if(cbxCenter.getSelectedItem().toString().equals("NTFE")){
      reportName = "NTFE_SHIP_COMP.rpt";
    }else{
      reportName = "HK_SHIP_COMP.rpt";
    }

...
public class TgrRxOperation extends CommandTrigger {
  public TgrRxOperation() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    try{
      ...
      PnlRxOperation pnlRxOperation=new PnlRxOperation();
      javax.swing.JFrame jframe = processhandler.template.Properties.getMainFrame();
      jframe.getContentPane().removeAll();
      jframe.getContentPane().setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));

      pnlRxOperation.setSize(800, 600);
      jframe.getContentPane().add(pnlRxOperation);

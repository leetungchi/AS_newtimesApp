...
public class PnlRptAccChkGap
  ...
  void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("傳票張數表");
  ...
  public void genDataBindObj(){
   ...
   public HashMap composeParameters(){
     ...
     if(dbTxtPayDateFrom.getSelectedValue()!=null){
       String dateStr=df.format(dbTxtPayDateFrom.getSelectedValue());
       dateStr=dateStr.substring(3,8);
       hm.put("P_YM_FM",dateStr);
     }
     if(dbTxtPayDateTo.getSelectedValue()!=null){
       String dateStr=df.format(dbTxtPayDateTo.getSelectedValue());
       dateStr=dateStr.substring(3,8);

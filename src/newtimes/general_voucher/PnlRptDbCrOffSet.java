...
public class PnlRptDbCrOffSet
  ...
  void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("資產負債類沖帳餘額明細表");
    ...
    whiteBkgBlueCharLabel2.setBounds(new Rectangle(471, 46, 129, 23));
    whiteBkgBlueCharLabel2.setForeground(new Color(113, 113, 178));
    whiteBkgBlueCharLabel2.setText("表頭年月(YYYYMM):");
    txtTitleYM.setText("");
    txtTitleYM.setBounds(new Rectangle(602, 46, 70, 23));
  ...
  public void genDataBindObj(){
    ...
    try{
      ...
      reportName = "ACC_DBCR_OFFSET.rpt";
  ...
  void btnRpt_actionPerformed(ActionEvent e) {
     ...
     String tempURL=newtimes.production.report.ReportCmdSet.myReportEngin.reportServerURL;
  ...
  super.JButtonQueryButtonAction(null);
   newtimes.production.report.ReportCmdSet.myReportEngin.reportServerURL=tempURL;

...
public class PnlRptAccPur
  ...
  JComboBox cbxAccItem = null;//new JComboBox();
  ...
  void jbInit() throws Exception {
    exgui.ultratable.Wraper4tblCbx cbxitem[]=new exgui.ultratable.Wraper4tblCbx[2];
    cbxitem[0]= new exgui.ultratable.Wraper4tblCbx();
    cbxitem[1]= new exgui.ultratable.Wraper4tblCbx();
    cbxitem[0].setString("進貨(6101)");
    cbxitem[0].setValue("6101");
    cbxitem[1].setString("銷貨(4101)");
    cbxitem[1].setValue("4101");
    cbxAccItem=new JComboBox(cbxitem);

    blueBkgWhiteCharLabel1.setFont(new java.awt.Font("Dialog", 1, 14));
    blueBkgWhiteCharLabel1.setText("進貨帳 / 銷貨帳");
    ...
    btnQry.setBounds(new Rectangle(687, 42, 95, 27));
    ...
    cbxAccItem.setBounds(new Rectangle(530, 42, 140, 25));
    blueBkgWhiteCharLabel3.setBounds(new Rectangle(478, 42, 52, 25));
    blueBkgWhiteCharLabel3.setText("科目");
  ...
  public  HashMap composeParameters(){
    ...
    hm.put("P_VH_CODE",((exgui.ultratable.Wraper4tblCbx)cbxAccItem.getSelectedItem()).getValue());
    return hm;
  }

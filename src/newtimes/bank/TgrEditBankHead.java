...
public class TgrEditBankHead extends CommandTrigger{
  static DbBankHead dbHandler=null;
  public TgrEditBankHead() {
  ...
  protected void addGui(){
    ...
    jframe.getContentPane().setCursor(new Cursor(
        Cursor.WAIT_CURSOR));
    PnlEditBankHead pnl=new PnlEditBankHead();
    pnl.setRecord(Constants.CURRENT_EDITING_BANK_HEAD_RECORD);
    if(dbHandler==null)dbHandler=new DbBankHead();
    pnl.record2Gui();

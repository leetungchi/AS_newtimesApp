...
public class TgrQryChkDtl extends CommandTrigger{
  public TgrQryChkDtl() {
  }
  protected void addGui(){
    ...
    jframe.getContentPane().setCursor(new Cursor(
        Cursor.WAIT_CURSOR));
    PnlQryCheckDtl pnl=null;
    if(Constants.PNL4QRYBANKDTL==null){
       pnl=new PnlQryCheckDtl();
       Constants.PNL4QRYBANKDTL=pnl;
    }else{
      pnl=(PnlQryCheckDtl)Constants.PNL4QRYBANKDTL;
    }

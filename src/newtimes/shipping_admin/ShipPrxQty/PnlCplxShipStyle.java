...
public class PnlCplxShipStyle  extends
//  JPanel //{
   ...
   implements Intf_get_Po_Ship_Qty_Pnl
 {
  ...
  JTextField txtScPayTerm = new JTextField();
  JLabel jLabel111 = new JLabel();
  JTextField txtCtPayTerm = new JTextField();

  public PnlCplxShipStyle() {
    try {
...
protected  void jbInit() throws Exception {
    ...
    titledBorder7 = new TitledBorder(border4,"Payment Term");
    ...
    this.setLayout(null);
    jLabel21.setBounds(new Rectangle(288, 50, 52, 20));
    ...
    txtDiv.setBounds(new Rectangle(346, 22, 132, 21));
    ...
    lblHts.setBackground(new Color(143, 143, 188));
    lblHts.setFont(new java.awt.Font("Dialog", 1, 12));
    lblHts.setForeground(new Color(106,36,10));
    lblHts.setOpaque(true);
    lblHts.setHorizontalAlignment(SwingConstants.LEFT);
    lblHts.setText(" HTS CODE :");
    lblHts.setBounds(new Rectangle(450, 51, 76, 20));
    ...
    txtFTY.setBounds(new Rectangle(39, 22, 106, 21));
    ...
    txtSea.setBounds(new Rectangle(155, 50, 128, 21));
    ...
    txtYear.setText("");
    txtYear.setBounds(new Rectangle(43, 50, 59, 20));
    ...
    jLabel9.setText("S/C# :");
    jLabel9.setBounds(new Rectangle(148, 22, 38, 20));
    ...
    jLabel19.setBounds(new Rectangle(288, 22, 59, 20));
    ...
    jLabel7.setBounds(new Rectangle(103, 50, 54, 20));
    ...
    txtScNo.setText("");
    txtScNo.setBounds(new Rectangle(186, 22, 99, 20));
    ...
    txtRange.setBounds(new Rectangle(340, 50, 134, 20));
    jLabel15.setBounds(new Rectangle(6, 22, 33, 20));
    ...
    jLabel10.setBounds(new Rectangle(6, 50, 38, 20));
    txtBuyComm.setText("");
    ...
    txtHgtType.setBounds(new Rectangle(525, 51, 90, 20));

    jPanel1.setBackground(new Color(204, 204, 225));
    jPanel1.setBorder(titledBorder7);
    jPanel1.setBounds(new Rectangle(482, 10, 257, 69));
    jPanel1.setLayout(null);
    jLabel110.setBounds(new Rectangle(4, 17, 34, 20));
    jLabel110.setText("S/C:");
    ...
    txtScPayTerm.setBounds(new Rectangle(38, 17, 214, 21));
    txtScPayTerm.setEditable(false);
    txtScPayTerm.setFont(new java.awt.Font("Dialog", 1, 11));
    txtScPayTerm.setEnabled(false);
    ...
    jLabel111.setText("C/T:");
    jLabel111.setBounds(new Rectangle(4, 40, 34, 20));
    txtCtPayTerm.setEnabled(false);
    txtCtPayTerm.setFont(new java.awt.Font("Dialog", 1, 11));
    txtCtPayTerm.setEditable(false);
    txtCtPayTerm.setBounds(new Rectangle(38, 40, 214, 21));
    ...
    jPanel1.add(txtScPayTerm, null);
    jPanel1.add(jLabel111, null);
    jPanel1.add(txtCtPayTerm, null);
  ...
  class CopyPoQtyAction extends java.awt.event.MouseAdapter{
    public void mouseClicked(java.awt.event.MouseEvent me){
      for(int i=0;i<pnlShipPrxQty.getJtable().getRowCount();i++){
        for(int j=6;j<pnlShipPrxQty.getJtable().getColumnCount();j++){
  ...
  public void record2Gui(){
    ...
    try{
      ...
      txtScPayTerm.setText((String)recToMapping.get("_$PROD_PYT_TRM"));txtScPayTerm.setEditable(false);
      txtCtPayTerm.setText((String)recToMapping.get("_$PROD_CT_PYT_TRM"));txtCtPayTerm.setEditable(false);
...
//    float scr_shipBuyerComm=Float.parseFloat(txtBuyComm.getText());
 ...
 //    System.out.println(""+styleBuyerComm+" <-> "+ shipBuyerComm+" <-> "+ scr_shipBuyerComm);
      ...
      try{
        ...
        if(isAddNew){
          ...
          javax.swing.JFrame jframe = processhandler.template.Properties.
              getMainFrame();
          newtimes.shipping_admin.ShipPrxQty.PnlCplxShipStyle   pnl=this;

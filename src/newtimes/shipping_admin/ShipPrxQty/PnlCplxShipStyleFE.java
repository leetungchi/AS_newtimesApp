...
public class PnlCplxShipStyleFE  extends
  //JPanel{
...
protected  void jbInit() throws Exception {
    ...
    titledBorder6 = new TitledBorder(new EtchedBorder(EtchedBorder.RAISED,Color.white,new Color(142, 142, 157)),"Buyer Comm.");
    border5 = new EtchedBorder(EtchedBorder.RAISED,Color.white,new Color(142, 142, 157));
    titledBorder7 = new TitledBorder(border5,"Maker Discount");
    ...
    jPanel3.setBounds(new Rectangle(2, 115, 744, 150));
    ...
    pnl2PlaceShipQty.setBackground(new Color(204, 204, 225));
    pnl2PlacePOQty.setBackground(new Color(204, 204, 225));
    pnlBuyerComm.setBackground(new Color(204, 204, 225));
    pnlBuyerComm.setBorder(titledBorder6);
    pnlBuyerComm.setBounds(new Rectangle(459, 267, 282, 84));
    pnlBuyerComm.setLayout(null);
    pnlMakerComm.setLayout(null);
    pnlMakerComm.setBounds(new Rectangle(459, 370, 283, 93));
    pnlMakerComm.setBorder(titledBorder7);
    ...
    pnl2PlaceShipQty.setBounds(new Rectangle(4, 266, 456, 201));
      ...
      try{
        ...
        if(isAddNew){
          ...
          javax.swing.JFrame jframe = processhandler.template.Properties.
              getMainFrame();
          newtimes.shipping_admin.ShipPrxQty.PnlCplxShipStyleFE   pnl=this;

...
public class PnlCplxShipStyle4Lauren  extends
  //JPanel{
  ...
  public PnlCplxShipStyle4Lauren() {
    try {
    ...
    if(!ifShipQtyGreaterThanZero())return;
      ...
      try{
        ...
        if(isAddNew){
          ...
          String asnNo=(String)
              newtimes.shipping_admin.process.shiippingmaintain.TgrToAddSty2Shipping.RECORD_SHIP_DETAIL_FROM_ASN.get("ASN_NO");
          String vendorinv_no=(String)
              newtimes.shipping_admin.process.shiippingmaintain.TgrToAddSty2Shipping.RECORD_SHIP_DETAIL_FROM_ASN.get("vendorinv_no");
          String sty_seq=
              newtimes.shipping_admin.ShippingAdmin_Const.EDITING_SHIPPING_STYLE_RECORD.get("STY_SEQ").toString();
          ...
          newtimes.shipping_admin.guis.shippingmaintain.PnlListStyle2AddFromAsn.HM_ADDED_RECORDS.put(keStr,recToMapping.get(0).toString());

        }else{
          javax.swing.JFrame jframe = processhandler.template.Properties.
              getMainFrame();
          newtimes.shipping_admin.ShipPrxQty.PnlCplxShipStyle4Lauren   pnl=this;

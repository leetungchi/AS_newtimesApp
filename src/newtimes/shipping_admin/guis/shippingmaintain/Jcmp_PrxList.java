...
import newtimes.shipping_admin.process.shiippingmaintain.DB_ShippingStylePrice;
...
public class Jcmp_PrxList extends PnlTableEditor {
  static final String LICENSEE = " \nLicensee";
  static final String COLOR = " \nColor";
  static final String BDP = "Buyer\nDoc Price";
  ...
  protected InsertionOrderedHashMap getHeadColumnMap() {
    if(iso == null){
      ...
      iso.put(LICENSEE, "LICENSEE_NAME");
      iso.put(COLOR, "COLOR_name");
  ...
  protected Hashtable getObject2StringConvertor() {
    Object flt73cnv=exgui.verification.CellFormat.getDoubleFormat(7,2);
  ...
  protected PagedDataFactory getPagedDataFactory() {
    DB_ShippingStylePrice prxSrc =new DB_ShippingStylePrice();
    return prxSrc;
  }

...
public class PnlShipMasterNTFE
  ...
  JButton btnCpyManufactureByFromOtherSRN = new JButton();
  JPanel pnlShipInvDesc = new JPanel();
  BorderLayout borderLayout6 = new BorderLayout();
  TitledBorder titledBorder12;
  Border border9;
  TitledBorder titledBorder13;
  JScrollPane jScrollPaneShipInvDesc = new JScrollPane();
  JTextArea txtShipInvDesc = new JTextArea();
  public PnlShipMasterNTFE() {
    //super();
    try{
    jbInit();
    afterJbinit();
  ...
  protected void afterJbinit(){
    ...
    lblStartSign.setBounds(new Rectangle(277, 242, 18, 20));
    ...
    btnCpyManufactureByFromOtherSRN = new JButton();
    btnCpyManufactureByFromOtherSRN.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        btnCpyManufactureByFromOtherSRN_actionPerformed(e);
      }
    });
    btnCpyManufactureByFromOtherSRN.setText("Copy From");
    btnCpyManufactureByFromOtherSRN.setFont(new java.awt.Font("Dialog", 1, 11));
    btnCpyManufactureByFromOtherSRN.setBounds(new Rectangle(119, 11, 119, 21));


    Pnl_manufacture.add(btnCpyManufactureByFromOtherSRN, null);
    ...
    pnlShipInvDesc.setBackground(new Color(202, 202, 225));
    pnlShipInvDesc.setBorder(titledBorder13);
    pnlShipInvDesc.setBounds(new Rectangle(4, 807, 760, 155));
    pnlShipInvDesc.setLayout(borderLayout6);
    this.add(pnlShipInvDesc, null);
    pnlShipInvDesc.add(jScrollPaneShipInvDesc, BorderLayout.CENTER);
    jScrollPaneShipInvDesc.getViewport().add(txtShipInvDesc, null);
  ...
  protected void jbInit(){
    ...
    titledBorder13 = new TitledBorder(border9,"Invoice Description");
    this.setLayout(null);
    ...
    jLabel25.setBounds(new Rectangle(287, 4, 101, 20));
    ...
    jLabel121.setBounds(new Rectangle(558, 3, 63, 20));
    ...
    jLabel11.setBounds(new Rectangle(130, 242, 39, 20));
    ...
    txtShipETDdate.setBounds(new Rectangle(45, 242, 80, 20));
    jLabel17.setBounds(new Rectangle(294, 242, 126, 20));
    ...
    txtShipETAdate.setBounds(new Rectangle(168, 242, 81, 20));
    cbxShipOrgCnty.setBounds(new Rectangle(420, 242, 135, 20));
   ...
   for(int i=0;i<toListen.length;i++){
    ...
    lblShipStaff.setText("<html><body>&nbsp;&nbsp;BUYER INV#:</body></html>");
    ...
    */
    ...
    jLabel1119.setBounds(new Rectangle(286, 27, 101, 20));
    txtShip_Ic_Year.setText("");
    txtShip_Ic_Year.setBounds(new Rectangle(386, 27, 135, 20));
  ...
  public void record2Gui() {
    ...
    try{
      ...
      dataBoundGUIs.add(
          ...
          "DEST_NAME", "DEST_NAME",
          recToMapping.get("SHIP_NTFE_DEST"), "", null, 30));
   ...
   Object vftxtMidVfy=
     ...
     Object vftxtShipInvDesc=exgui.verification.CellFormat.getOrdinaryField(1000);
      dataBoundGUIs.add(
        new exgui.DataBindTextWithChecker(txtShipInvDesc,"SHIP_INV_DESC",
                                          recToMapping.get("SHIP_INV_DESC"),1000,
                                          (exgui.Object2String)vftxtShipInvDesc,
                                          (exgui.ultratable.CellTxtEditorFormat)vftxtShipInvDesc)
     );
      ...
      /*
      exgui.DataBindJCombobox  DbJcbxcbxShipType =
         new exgui.DataBindJCombobox(
         cbxIcInvType,"SHIP_IC_INV_TYPE",
         vctShipType,"TYPE_NAME",
         "TYPE_CODE",
         recToMapping.get("SHIP_IC_INV_TYPE"),
         "",null);
        dataBoundGUIs.add(DbJcbxcbxShipType);
       */

       recordColumnsToCopy=(String[])columns.toArray(new String[0]);

       //System.out.println("SHIP_MANUFACTURE is :"+recToMapping.get("SHIP_MANUFACTURE"));
       ...
       lblIcInvType.setText(lblIcInvType.getText()+
                            ...
                            ((inv_ic_type==2)?" IC":" "))));
       //for ntfe,have to set "price term dest" as editable combobox
       for(int i=0;i<dataBoundGUIs.size();i++){
         exgui.DataBindGUIObject  dbObj=(exgui.DataBindGUIObject)dataBoundGUIs.get(i);
         if(dbObj.getOrgRecField().toLowerCase().equals("ship_prx_term_dest")){
           cbxPriceTermDest.setEditable(true);
           dataBoundGUIs.set(i,
                       new exgui.DataBindEditableJCombobox(
                       cbxPriceTermDest,
                       "ship_prx_term_dest",
                       newtimes.shipping_admin.ShippingAdmin_Const.DESTINATIONS,
                       "dest_name",
                       "dest_name", recToMapping.get("ship_prx_term_dest"),60));
              break;
         }
       }
    }catch(Exception exp){
    ...
    try{
      ...
      Object objScNo = recToMapping.get("SHIP_NO");
       ...
       for(int i=0;i<recordColumnsToCopy.length;i++){
         ...
         /*
         System.out.print("recordColumnsToCopy["+i+"]=");
         System.out.print(recordColumnsToCopy[i]);
         System.out.print(" value is ");
         System.out.print(recCopiedDup.get(recordColumnsToCopy[i]));
         System.out.print("\n");*/
       }
       //lblTItleBar.setText("SRN DATA");
  ...
  protected void makeTextContext(javax.swing.text.JTextComponent txt2set,
    ...
    //System.out.println("buyer makere data =====>"+recBuyerMaker.toString());
    StringBuffer sb=new StringBuffer();
    ...
    sb.append(fullName);
    sb.append("\n");
    if(null!=name2 && (!"".equals(name2.trim()))){
     sb.append(name2);
     sb.append("\n");
    }
   /*
    ...
    for (int i = 15; i < 20; i++) {
      ...
      if(recBuyerMaker.getFieldName().get(i).equals("BYMKR_HK_CODE"))continue;
  ...
  void btnCpyManufactureByFromOtherSRN_actionPerformed(ActionEvent e) {
    copyAndPastRemark("SHIP_MANUFACTURE",txtShipManufacture);
  }

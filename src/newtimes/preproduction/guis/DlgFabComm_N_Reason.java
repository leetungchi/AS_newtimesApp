...
public class DlgFabComm_N_Reason extends JDialog {
  ...
  public DlgFabComm_N_Reason(Frame frame, String title, boolean modal,String str2show) {
  ...
  protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("Please Input Reason When No Comm in \"N\"");
    ...
    exgui.DataBindText  dbTxtBindText=
        new exgui.DataBindText(txtReason, null, orgTextContext, 50);

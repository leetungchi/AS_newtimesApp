...
public class TgrPrintScStickerLbl extends CommandTrigger{
  public TgrPrintScStickerLbl() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    ...
    javax.swing.JFrame jframe=processhandler.template.Properties.getMainFrame();
       ...
       PnlPrintScStickerLbl pnl=new PnlPrintScStickerLbl();
       pnl.jbInit();
       ...
       processhandler.template.Properties.getSplitFrame().setDividerLocation(0.33);

...
public class PnlSalesProfitRptXmonth
    extends  AbsQryPanel{
    //extends JPanel {
  ...
  public PnlSalesProfitRptXmonth() {
    try {
      //jbInit();
    }
    catch(Exception ex) {
  ...
  void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("SALES PROFIT REPORT SINGLE MONTH");
    ...
    java.awt.GridLayout gdLayout=new java.awt.GridLayout(7,2);
    pnlDeps.setLayout(gdLayout);
    /*
  ...
  protected void genDataBindObj(){
    try{
     ...
     dataBindComps.add(dbHkdChg);
      ...
      this.add(lblCbmD, null);
      this.add(cbxCbmD, null);
      reportName ="PROFIT_MONTH_TPE.rpt";

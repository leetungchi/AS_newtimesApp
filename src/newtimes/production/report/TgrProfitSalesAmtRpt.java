...
public class TgrProfitSalesAmtRpt extends processhandler.CommandTrigger {
  boolean isProfitRpt;
  public TgrProfitSalesAmtRpt(boolean _isProfitRpt) {
    isProfitRpt=_isProfitRpt;
  ...
  public void activateThisProcess() throws processhandler.commands.CommandException{
    ...
    javax.swing.JFrame jframe=processhandler.template.Properties.getMainFrame();
       ...
       PnlProfitSaleAmtRpt  pnl=new PnlProfitSaleAmtRpt();
       pnl.isProfitRpt=isProfitRpt;
       pnl.jbInit();

...
public class ToGenRptSCCnfmList implements AbleToGenRptSCCnfmList{
  public ToGenRptSCCnfmList() {

  }
  public void toGenRptSCCnfmList() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlQry_SC_CnfmList    pnl=new PnlQry_SC_CnfmList();
       //pnl.jbInit();

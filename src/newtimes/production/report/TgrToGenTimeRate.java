...
public class TgrToGenTimeRate extends CommandTrigger {
  public TgrToGenTimeRate() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
        ...
        try{
          ...
          //System.out.println("is report engine ok ? "+newtimes.production.report.ReportCmdSet.myReportEngin.checkOk());
           ...
           PnlTimeRateRpt  pnl=new PnlTimeRateRpt();
           pnl.jbInit();

...
protected  void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("J.L. PO Item_ID Qty");
...
//      cld.set(cld.DATE,cld.getActualMaximum(cld.DAY_OF_YEAR));
 ...
 /*     dbCbxSzn= new exgui.DataBindJCombobox(
      ...
      super.reportName="JL_PO_QTY.rpt";
    }catch(Exception exp){
       exp.printStackTrace();
    }
  }
 ...
 //   java.util.HashMap hm=super.composeParameters();
    java.util.HashMap hm = new java.util.HashMap();
          hm.put("P_PO",jTextField1.getText());

...
public class ToGenRptShipPendding implements AbleToGenRptShipPendding{
  public ToGenRptShipPendding() {

  }
  public void toGenRptShipPendding() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlShipPending pnl=new PnlShipPending();
       pnl.jbInit();

...
public class TgrToGenFabCommMkrDisctLessStandardRpt extends CommandTrigger{
  public TgrToGenFabCommMkrDisctLessStandardRpt() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
        ...
        try{
          ...
          System.out.println("is report engine ok ? "+
           ...
           PnlFabCommMkrDiscLessStandard  pnl=new PnlFabCommMkrDiscLessStandard();
           pnl.jbInit();

...
public class ToGenRptShippingList implements AbleToGenRptShippingList{
  public ToGenRptShippingList() {

  }
  public void toGenRptShippingList() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlQryShipList  pnl=new PnlQryShipList();
       pnl.jbInit();
       processhandler.template.Properties.getSplitFrame().setPanel(
          pnl,
          tempDownPnl
        );
       processhandler.template.Properties.getSplitFrame().setDividerLocation(0.50);

...
public class TgrPenddingAndShippingReport  extends CommandTrigger {
  public TgrPenddingAndShippingReport() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    ...
    try{
      while(!newtimes.preproduction.process.AttributeFactory.isAllAccsAttribReady()){
       ...
       PnlPendingAndShipping pnl=new PnlPendingAndShipping();
       pnl.jbInit();

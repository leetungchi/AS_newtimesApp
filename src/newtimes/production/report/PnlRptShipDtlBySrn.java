...
public class PnlRptShipDtlBySrn
    //extends JPanel {
    extends AbsQryPanel{
 ...
 protected void jbInit() throws Exception {
    ...
    this.setLayout(null);
    blueBkgWhiteCharLabel3.setBounds(new Rectangle(10, 36, 60, 19));
    blueBkgWhiteCharLabel3.setText("Center");
    jLabel1.setText("DEP.");
    jLabel1.setBounds(new Rectangle(11, 61, 47, 21));
    blueBkgWhiteCharLabel1.setText(" SHIP DETAIL BY SRN ");
    blueBkgWhiteCharLabel1.setBounds(new Rectangle(0, 3, 803, 28));
    cbxCntr.addItemListener(new cbxCenterItemChanged());
    cbxCntr.setBounds(new Rectangle(54, 38, 130, 19));
    btnQry.setBounds(new Rectangle(717, 91, 80, 27));
    btnQry.setFont(new java.awt.Font("Dialog", 1, 11));
    btnQry.setText("REPORT");
    btnQry.addActionListener(new PnlRptShipDtlBySrn_btnQry_actionAdapter(this));
    cbxDep.setBounds(new Rectangle(54, 64, 186, 22));
    ...
    lblBuyer.setBounds(new Rectangle(302, 36, 61, 26));
    slkBuyer.setBounds(new Rectangle(350, 39, 153, 24));
    lblYear.setText("YEAR");
    lblYear.setBounds(new Rectangle(192, 36, 42, 19));
    txtYear.setText("");
    txtYear.setBounds(new Rectangle(237, 36, 53, 21));
    ...
    slkMaker.setBounds(new Rectangle(297, 66, 153, 24));
    lblBuyer1.setBounds(new Rectangle(249, 66, 54, 26));
    lblBuyer1.setText("MAKER");
    jLabel8.setBounds(new Rectangle(182, 93, 111, 21));
    jLabel8.setText("EXCLUDE SAMPLE");
    cbxXldSmpl.setBounds(new Rectangle(296, 93, 136, 21));
    ...
    genDataBindObj();
    reportName="ACC_SHIP_SC_AMT.rpt";
}
...
public HashMap composeParameters() {
  ...
  hm.put("P_EXP_SMP",cbxXldSmpl.getSelectedItem().toString().substring(0,1)) ;
...
TitledBorder titledBorder1;
  ...
  JComboBox cbxXldSmpl = new JComboBox(new String[]{"Yes","No"});

}

class PnlRptShipDtlBySrn_btnQry_actionAdapter implements java.awt.event.
  ActionListener {
PnlRptShipDtlBySrn adaptee;

 PnlRptShipDtlBySrn_btnQry_actionAdapter(PnlRptShipDtlBySrn adaptee) {

...
public class PnlPrt4Inspection
    //extends JPanel {
    extends AbsQryPanel{
 ...
 protected   DataBindTextWithChecker dbTxtDateBgn,dbTxtDateEnd,dbTwdChg,dbHkdChg,dbRmbChg,dbInspxnFrom,dbInspxnTo;
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("INSPECTION REPORT");
    blueBkgWhiteCharLabel1.setBounds(new Rectangle(0, 0, 800, 18));
    this.setLayout(null);
    lblCountry.setText("COUNTRY");
    lblCountry.setBounds(new Rectangle(6, 27, 78, 17));
    cbxCenter.setBounds(new Rectangle(186, 273, 126, 22));
    lblCenter.setText("CENTER");
    lblCenter.setBounds(new Rectangle(103, 273, 82, 19));
    cbxCountry.setBounds(new Rectangle(70, 27, 124, 20));
    ...
    lblDDFrom.setBounds(new Rectangle(201, 27, 72, 21));
    lblDDFrom.setText("DEL. FROM:");
    txtDelFrom.setBounds(new Rectangle(272, 27, 71, 21));
    txtDelFrom.setText("");
    lblYear2.setBounds(new Rectangle(345, 27, 37, 20));
    lblYear2.setText("TO:");
    txtDelTo.setBounds(new Rectangle(381, 27, 71, 21));
    txtDelTo.setText("");
    ...
    rdoIncludeSCNULL.setBounds(new Rectangle(720, 48, 54, 22));
    rdoXcldSCNULL.setBackground(new Color(204, 204, 225));
    rdoXcldSCNULL.setText("YES");
    rdoXcldSCNULL.setBounds(new Rectangle(651, 48, 68, 22));
    lblToExcludeSC.setText("EXCLUDE S/C NO IS SPACE:");
    lblToExcludeSC.setBounds(new Rectangle(474, 48, 167, 24));
    rdoUnshipNo.setBounds(new Rectangle(658, 87, 104, 22));
    rdoUnshipNo.setText("ORDER");
    rdoUnshipNo.setSelected(true);
    rdoUnshipNo.setBackground(Color.white);
    rdoUnshipYes.setBounds(new Rectangle(540, 87, 118, 22));
    rdoUnshipYes.setText("UNSHIPPED");
    rdoUnshipYes.setBackground(Color.white);
    ...
    lblInspXnFrom.setText("INSPECTION DATE FROM:");
    lblInspXnFrom.setBounds(new Rectangle(462, 27, 149, 21));
    lblInspxnTo.setText("TO:");
    lblInspxnTo.setBounds(new Rectangle(684, 27, 37, 20));
    txtInspxnFrom.setText("");
    txtInspxnFrom.setBounds(new Rectangle(611, 27, 71, 21));
    txtInspxnTo.setBounds(new Rectangle(708, 27, 71, 21));
    ...
    buttonGroup2.add(rdoUnshipNo);
    buttonGroup2.add(rdoUnshipYes);
    this.add(txtDelTo, null);
    this.add(rdoUnshipYes, null);
    this.add(rdoUnshipNo, null);
  ...
  protected void genDataBindObj(){
    try{
     ...
     dataBindComps.add(dbHkdChg);
      ...
      this.add(txtDelTo, null);
      this.add(lblInspXnFrom, null);
      this.add(txtInspxnFrom, null);
      this.add(lblInspxnTo, null);
      this.add(txtInspxnTo, null);
      this.add(lblInspXnFrom, null);
      this.add(txtDelTo, null);
      this.add(lblYear2, null);
      this.add(txtDelFrom, null);
     ...
     if(util.PublicVariable.OPERATTING_CENTER.equals("001")){
       reportName = "prod_style.rpt";
     }else if(util.PublicVariable.OPERATTING_CENTER.equals("NTFE")){
       reportName = "ntfe_prod_style.rpt";
     }else if(util.PublicVariable.OPERATTING_CENTER.equals("CG")){
       reportName = "ntfe_prod_style.rpt";
     }else{
       reportName = "hk_prod_style.rpt";
     }
     */
    reportName="INSP_PROD_DETAIL.rpt";
     doingDB2Gui=false;
     ...
     dbInspxnFrom =
         new exgui.DataBindTextWithChecker(txtInspxnFrom, "P_INSP_FM", null,
                                           10, (exgui.Object2String)dateVfy,
                                           (exgui.ultratable.
                                            CellTxtEditorFormat)dateVfy);
     dataBindComps.add(dbInspxnFrom);
     dbInspxnTo =
         new exgui.DataBindTextWithChecker(txtInspxnTo, "P_INSP_TO", null,
                                           10, (exgui.Object2String)dateVfy,
                                           (exgui.ultratable.
                                            CellTxtEditorFormat)dateVfy);
     dataBindComps.add(dbInspxnFrom);
 ...
 protected void udpateDepComboBox(){
  ...
  protected java.util.HashMap composeParameters(){
    ...
    Object inspDateBgn=dbInspxnFrom.getSelectedValue();
    Object inspDateEnd=dbInspxnTo.getSelectedValue();
    if(inspDateBgn==null){
      hm.put("P_INSP_FM","DATE(2000,01,01)");
    }
    if(inspDateEnd==null){
      hm.put("P_INSP_TO","DATE(2099,12,31)");
    }
  ...
  JRadioButton rdoUnshipNo = new JRadioButton();
  JRadioButton rdoUnshipYes = new JRadioButton();
  ...
  JTextField txtInspxnTo = new JTextField();
  JLabel lblInspXnFrom = new JLabel();
  JLabel lblInspxnTo = new JLabel();
  JTextField txtInspxnFrom = new JTextField();

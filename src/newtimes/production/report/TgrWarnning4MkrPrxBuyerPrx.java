...
public class TgrWarnning4MkrPrxBuyerPrx  extends processhandler.CommandTrigger {
  public TgrWarnning4MkrPrxBuyerPrx() {
  ...
  public void activateThisProcess() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlWarnning4MkrPrxBuyerPrx  pnl=new PnlWarnning4MkrPrxBuyerPrx(null);
       pnl.jbInit();
       processhandler.template.Properties.getSplitFrame().setPanel(
          pnl,
          tempDownPnl
        );
       processhandler.template.Properties.getSplitFrame().setDividerLocation(0.2);

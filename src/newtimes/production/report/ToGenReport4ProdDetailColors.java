...
public class ToGenReport4ProdDetailColors implements AbleToGenReport4ProdDetailColors{
  public ToGenReport4ProdDetailColors() {

  }
  public void toGenReport4ProdDetailColors() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlRptProdDtlColor pnl=new PnlRptProdDtlColor();
       pnl.jbInit();

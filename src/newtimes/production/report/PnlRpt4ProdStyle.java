...
public class PnlRpt4ProdStyle
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("ORDER / UNSHPPED DETAIL BY STYLE");
    ...
    lblDDFrom.setBounds(new Rectangle(487, 20, 72, 21));
    lblDDFrom.setText("DEL. FROM:");
    txtDelFrom.setBounds(new Rectangle(563, 19, 71, 21));
    txtDelFrom.setText("");
    lblYear2.setBounds(new Rectangle(637, 17, 37, 20));
    lblYear2.setText("TO:");
    txtDelTo.setBounds(new Rectangle(678, 17, 71, 21));
    txtDelTo.setText("");
    ...
    rdoIncludeSCNULL.setBounds(new Rectangle(715, 58, 54, 22));
    rdoXcldSCNULL.setBackground(new Color(204, 204, 225));
    rdoXcldSCNULL.setText("YES");
    rdoXcldSCNULL.setBounds(new Rectangle(646, 58, 68, 22));
    lblToExcludeSC.setText("EXCLUDE S/C NO IS SPACE:");
    lblToExcludeSC.setBounds(new Rectangle(469, 58, 167, 24));
    rdoUnshipNo.setBounds(new Rectangle(659, 77, 104, 22));
    rdoUnshipNo.setText("ORDER");
    rdoUnshipNo.setSelected(true);
    rdoUnshipNo.setBackground(Color.white);
    rdoUnshipYes.setBounds(new Rectangle(541, 77, 118, 22));
    ...
    lblDivision.setBounds(new Rectangle(541, 106, 60, 22));
    cbxDivision.setBounds(new Rectangle(605, 106, 150, 22));
    lblProdType.setText("TYPE");
    lblProdType.setBounds(new Rectangle(542, 131, 55, 21));
    cbxProdType.setBounds(new Rectangle(605, 131, 150, 22));
    jLabel1.setText("MANAGER:");
    jLabel1.setBounds(new Rectangle(536, 152, 71, 22));
    cbxManager.setBounds(new Rectangle(605, 154, 150, 22));
    lblXldSmpl.setBounds(new Rectangle(534, 180, 134, 22));
    lblXldSmpl.setText("EXCLUDE SAMPLE");
    cbxXldSmpl.setBounds(new Rectangle(675, 178, 80, 22));
    lblAgent.setText("AGENT");
    lblAgent.setBounds(new Rectangle(484, 38, 70, 22));
    slkAgent.setBounds(new Rectangle(539, 39, 196, 20));
    ...
    this.add(lblXldSmpl,null);
    this.add(cbxXldSmpl,null);
    this.add(slkAgent, null);
    this.add(lblAgent,null);

...
public class ToShippDtlByColor implements AbleToShippDtlByColor{
  public ToShippDtlByColor() {

  }
  public void toShippDtlByColor() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlShipDtlColor pnl=new PnlShipDtlColor();
       pnl.jbInit();

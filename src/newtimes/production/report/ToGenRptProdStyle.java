...
public class ToGenRptProdStyle implements AbleToGenRptProdStyle{
  public ToGenRptProdStyle() {

  }
  public void toGenRptProdStyle() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlRpt4ProdStyle pnl=new PnlRpt4ProdStyle();
       pnl.jbInit();

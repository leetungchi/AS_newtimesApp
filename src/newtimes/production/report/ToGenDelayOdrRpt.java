...
public class ToGenDelayOdrRpt implements AbleToGenDelayOdrRpt{
  public ToGenDelayOdrRpt() {

  }
  public void toGenDelayOdrRpt() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlQryDelayOdr   pnl=new PnlQryDelayOdr();
       //pnl.jbInit();

...
public class PnlQryShipList extends PnlRpt4ProdStyle {
  ...
  protected void jbInit()throws Exception{
    ...
    genDataBindObj();
    blueBkgWhiteCharLabel1.setText("SHIPPING DETAIL BY STYLE");
  }
     ...
     dbTxtInvDateEnd =
      ...
      if("NTHK".equals(util.PublicVariable.OPERATTING_CENTER)){
        if ((util.PublicVariable.USER_RECORD.getInt(2) ==
          ...
          reportName = "ship_lst.rpt";
        } else {
          reportName = "SHIP_LST_XPR.rpt";
        }
      }else{
        reportName = "ship_lst.rpt";
      }

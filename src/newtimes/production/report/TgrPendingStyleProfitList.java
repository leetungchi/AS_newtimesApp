...
public class TgrPendingStyleProfitList extends CommandTrigger{
  public TgrPendingStyleProfitList() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    ...
    try{
      ...
      newtimes.production.ProdMaintain_Properties.setWaitCursor();
         ...
         PnlPenddingStyleProfitList   pnl=new PnlPenddingStyleProfitList();
         pnl.jbInit();

...
public class PnlFabCommMkrDiscLessStandard extends AbsQryPanel {
  ...
  public PnlFabCommMkrDiscLessStandard() {
    try {
      //jbInit();
    }
    catch(Exception ex) {
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("FAB COMM & MAKER DISCOUNT LESS STANDARD");
    ...
    btnQry.addActionListener(new PnlFabCommMkrDiscLessStandard_btnQry_actionAdapter(this));
...
public void genDataBindObj() {
  ...
  try{
    ...
    dbTxtDateBgn =
        new exgui.DataBindTextWithChecker(txtDateBgn, "P_DEL_FM", dFrom,
    ...
    dbTxtDateEnd =
        new exgui.DataBindTextWithChecker(txtDateEnd, "P_DEL_TO", dEnd,
                                          10, (exgui.Object2String)dateVfy,
                                          (exgui.ultratable.
                                           CellTxtEditorFormat)dateVfy);
...
class PnlFabCommMkrDiscLessStandard_btnQry_actionAdapter implements java.awt.event.
  ActionListener {
PnlFabCommMkrDiscLessStandard adaptee;

PnlFabCommMkrDiscLessStandard_btnQry_actionAdapter(PnlFabCommMkrDiscLessStandard adaptee) {

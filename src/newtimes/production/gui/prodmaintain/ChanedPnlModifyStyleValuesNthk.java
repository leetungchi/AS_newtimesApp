...
public class ChanedPnlModifyStyleValuesNthk extends ChainedPnlDftStyleValueNthk {
  ...
  public ChanedPnlModifyStyleValuesNthk() {
    super();
    afterJbinit();
    txtTtlQty.setText("");
  }
...
//--------for qta object-----------------
 ...
 boolean  btnOK_actionPerformed(ActionEvent e) throws Exception{
   ...
   Object orgShipWay=recToMapping.get("STY_ORIG_WAY");
   if(orgShipWay!=null){
     recToMapping.set("STY_RECFM_SHIP",orgShipWay);
   }

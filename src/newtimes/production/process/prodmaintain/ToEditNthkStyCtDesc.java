...
public class ToEditNthkStyCtDesc extends ToEditStyCtDesc {
  public ToEditNthkStyCtDesc() {
  }
  public void toEditStyCtDesc()throws Exception{
    try{
     ...
     final newtimes.production.gui.prodmaintain.PnlNthkStyles_CT_DESC pnl=
         ...
         DB_NTHKStyleListHandler.force2UpdateCtProdPkMap());
     ...
     processhandler.template.Properties.getSplitFrame().setLowerPanel(
      ...
      //system will log the descriptions after PO-Detail shipped.

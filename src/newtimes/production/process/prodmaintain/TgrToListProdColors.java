...
public class TgrToListProdColors extends CommandTrigger {
  public TgrToListProdColors() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    ...
    if(commander instanceof AbleToListProdColors){
       try{
         ((AbleToListProdColors)commander).toListProdColors();

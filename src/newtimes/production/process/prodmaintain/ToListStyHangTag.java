...
public class ToListStyHangTag extends ToCheckB4StyleProc implements AbleToListStyHangTag{
  public ToListStyHangTag() {

  }
  public void toListStyHangTag()throws Exception{
    try{
      newtimes.production.ProdMaintain_Properties.setWaitCursor();
      newtimes.production.gui.prodmaintain.PnlStyHangTagList pnl =
          new newtimes.production.gui.prodmaintain.PnlStyHangTagList();
      if (!pnl.isInitOK()){
        throw new processhandler.commands.CommandIncompleteException();
      }
      addLowerPanel("=====STYLE HANG TAG EDIT=======", pnl);

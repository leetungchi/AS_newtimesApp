...
public class ToListNthkStyles extends ToListStyles {
  public ToListNthkStyles() {
  ...
  public void toListStyles()throws Exception{
    ...
    try{
      ...
      //String HK_SUBGRP=(String)newtimes.preproduction.Constants.CURRENT_PREPROD_HEAD_RECORD.get("production_HK_SUBGRP");
      ...
      sb.append(sc_no);
      /*
      if(HK_SUBGRP==null || HK_SUBGRP.trim().length()==0){
        sb.append(sc_no);
      }else{
        sb.append(HK_SUBGRP);sb.append("-");
        sb.append(sc_no.substring(1,7));
      }*/
      sb.append(" ");

...
public class ToEditStyScDesc extends ToCheckB4StyleProc implements AbleToEditStyScDesc{
  public ToEditStyScDesc() {
  ...
  public void toEditStyScDesc()throws Exception{
    try{
      ...
      newtimes.production.gui.prodmaintain.PnlStyles_SC_DESC pnl=
          new newtimes.production.gui.prodmaintain.PnlStyles_SC_DESC(prodRec,styles,ejb);

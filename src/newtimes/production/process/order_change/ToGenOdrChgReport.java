...
public class ToGenOdrChgReport implements AbleToGenOdrChgReport{
  public ToGenOdrChgReport() {
    ...
    try{
      ...
      */
       ...
       newtimes.production.report.ReportCmdSet.myReportEngin.directCallEngine2Xqt(
          "ORDER_CHANGE.RPT",null,mp);*/
         //newtimes.production.report.ReportCmdSet.myReportEngin.setReportName("ORDER_CHANGE.RPT");
         //newtimes.production.report.ReportCmdSet.myReportEngin.setPromptHashMap(mp);

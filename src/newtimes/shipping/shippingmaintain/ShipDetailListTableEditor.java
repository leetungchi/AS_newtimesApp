...
public class ShipDetailListTableEditor extends PnlTableEditor {
  ShipDetailListDataFactoryAdapter listDataSrc = null;
  ...
  public ShipDetailListTableEditor() {
    super.firstPage();
  ...
  protected PagedDataFactory getPagedDataFactory() {
    ShipDetailListDataFactoryAdapter detailSrc =
            ShipDetailListDataFactoryAdapter.getInstance();
    return detailSrc;
  }
}
...
public class PrxTableEditor extends PnlTableEditor {
  PrxDataFactoryAdapter listDataSrc = null;
  ...
  public PrxTableEditor() {
    ...
    System.out.println("Activate : PrxTableEditor()");
  }
  ...
  protected Hashtable getObject2StringConvertor() {
    Object flt73cnv=exgui.verification.CellFormat.getDoubleFormat(7,3);
  ...
  protected PagedDataFactory getPagedDataFactory() {
    PrxDataFactoryAdapter prxSrc =
        PrxDataFactoryAdapter.getInstance();
    return prxSrc;
  }

...
public class QtyDataFactoryAdapter extends PagedDataFactoryAdapter {
  ...
  public QtyDataFactoryAdapter() {
    ...
    try{
      ...
      shipPrices = exgui2.CONST.SHIP_QTY_EJB.getPrice(AddDetailList.SHIP_STYLE_PK);
      ...
      tempBlankRecord.set("SHIP_STYLE_PK", hm.get("SHIP_STYLE_PK"));
      ...
      System.out.println("activate QtyDataFactoryAdapter()");
      isInitOk = true;
    } catch(Exception e) {
      e.printStackTrace();
      isInitOk = false;
  ...
  public java.util.Vector getRecords(int bgn, int rowcount)throws Exception {
    ...
    if (!ShipDetailEdit.isShipQTY) {
      orgQryRecords = exgui2.CONST.SHIP_QTY_EJB.getSizeTypeFromQTY(this.stySeq);
    } else {
      orgQryRecords = exgui2.CONST.SHIP_QTY_EJB.getSizeTypeFromShipQTY(
        Integer.parseInt(hm.get("SHIP_STYLE_PK").toString()), this.stySeq);
  ...
  public void udpateQtyTbl2Text(String tbl2Text) throws Exception{
    exgui2.CONST.SHIP_QTY_EJB.updateStyleQtyDesc(AddDetailList.SHIP_STYLE_PK,
                                                 tbl2Text,

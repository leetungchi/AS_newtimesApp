...
public class ShipDetailEditGUIFromSC extends JPanel {
  JPanel jPanel1 = new JPanel();
  PrxTableEditorFromSC prxTableEditorSC = new PrxTableEditorFromSC();
  ...
  JButton butn_QTY_New1 = new JButton();
  JButton butn_QTY_Delete1 = new JButton();
  JButton butn_QTY_Edit1 = new JButton();

  public ShipDetailEditGUIFromSC() {
    try {
      jbInit();
    }
    catch(Exception ex) {
  ...
  void jbInit() throws Exception {
    this.setMaxLength();
    prxTableEditorSC.setBounds(new Rectangle(0, 0, 710, 243));
    jPanel1.setBackground(new Color(204, 204, 225));
    jPanel1.setLayout(null);
    this.setLayout(gridBagLayout1);
    this.setSize(new Dimension(763, 652));
    ...
    jLabel9.setBounds(new Rectangle(382, 24, 136, 20));
    txtYear.setEnabled(false);
    txtYear.setEditable(false);
    txtYear.setBounds(new Rectangle(520, 53, 98, 20));
    ...
    jLabel19.setBounds(new Rectangle(15, 53, 136, 20));
    jLabel7.setBounds(new Rectangle(15, 81, 136, 20));
    ...
    txtScNo.setBounds(new Rectangle(520, 24, 209, 20));
    ...
    jLabel10.setBounds(new Rectangle(382, 53, 136, 20));
    ...
    qtyTableEditorSC.setBounds(new Rectangle(0, 0, 710, 243));
    txtSea.setEnabled(false);
    txtSea.setEditable(false);
    txtSea.setBounds(new Rectangle(153, 81, 209, 21));
    txtDiv.setEnabled(false);
    txtDiv.setEditable(false);
    txtDiv.setBounds(new Rectangle(153, 53, 209, 21));
    txtFTY.setEnabled(false);
    txtFTY.setEditable(false);
    txtFTY.setBounds(new Rectangle(153, 24, 209, 21));
    jTabbedPane1.setBounds(new Rectangle(13, 50, 715, 269));
    ...
    butn_QTY_New1.setBounds(new Rectangle(2, 213, 79, 24));
    butn_QTY_New1.setFont(new java.awt.Font("Dialog", 0, 12));
    butn_QTY_New1.setText("New");
    butn_QTY_Delete1.setBounds(new Rectangle(168, 213, 79, 24));
    butn_QTY_Delete1.setFont(new java.awt.Font("Dialog", 0, 12));
    butn_QTY_Delete1.setText("Delete");
    butn_QTY_Edit1.setBounds(new Rectangle(85, 213, 79, 24));
    butn_QTY_Edit1.setFont(new java.awt.Font("Dialog", 0, 12));
    butn_QTY_Edit1.setText("Save");
    butn_QTY_Edit1.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        butn_QTY_Edit1_actionPerformed(e);
      }
    });
    ...
    this.add(jPanel1,  new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(8, 0, 4, 1), 761, 639));
    jPanel4.add(butn_QTY_New, null);
    jPanel4.add(butn_QTY_Delete, null);
    jPanel4.add(butn_QTY_Edit, null);
    jPanel6.add(butn_QTY_New1, null);
    jPanel6.add(butn_QTY_Delete1, null);
    jPanel6.add(butn_QTY_Edit1, null);
    ...
    jPanel4.add(qtyTableEditorSC, null);
    jPanel6.add(prxTableEditorSC, null);
    jPanel5.add(jTabbedPane1, null);
    jPanel1.add(jPanel3, null);
    this.setCmboPCB();
    butn_QTY_New1.setEnabled(false);
    butn_QTY_Delete1.setEnabled(false);
  }
  ...
  void butn_QTY_Edit1_actionPerformed(ActionEvent e) {
    try {
      prxTableEditorSC.doUpdate();
    } catch(Exception ex) {
      ex.printStackTrace();
  ...
  void jTabbedPane1_stateChanged(ChangeEvent e) {
    switch (jTabbedPane1.getSelectedIndex()) {
      case 0:
        qtyTableEditorSC.reload();
        break;
      case 1:
        prxTableEditorSC.reload();
        break;
    }
  }
}

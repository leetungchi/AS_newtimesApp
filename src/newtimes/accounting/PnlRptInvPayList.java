...
protected  void jbInit() throws Exception {
    ...
    txtDateFrom.setText("");
    blueBkgWhiteCharLabel1.setText("INVOICE PAYMENT LIST");
    ...
    slkBuyer.setBounds(new Rectangle(449, 47, 235, 25));

    jLabel2.setText("MAKER :");
    jLabel2.setBounds(new Rectangle(400, 84, 56, 30));
    slkMaker.setBounds(new Rectangle(449, 85, 235, 25));
/*
 ...
 */
    slkBuyer.init("P_BUYER",new Integer(12141),slkBuyer.TYPE_BUYER,true);
...
//      dbCbxSzn= new exgui.DataBindJCombobox(
 ...
 //     dataBindComps.add(dbCbxSzn);
      ...
      super.reportName="QS_DEDUCT.rpt";
    }catch(Exception exp){
       exp.printStackTrace();
    }
  }

...
public class PnlRptInvCommDisc
    //extends JPanel {
    extends AbsQryPanel{
...
protected  void jbInit() throws Exception {
    ...
    txtDateFrom.setText("");
    blueBkgWhiteCharLabel1.setText("LIST INVOICE Comm. & Disc.");
    ...
    jLabel2.setBounds(new Rectangle(400, 77, 56, 30));
    slkMaker.setBounds(new Rectangle(449, 80, 235, 25));
    ...
    slkBuyer.init("P_BUYER",new Integer(9898),slkBuyer.TYPE_BUYER,true);
  ...
  protected void genDataBindObj(){
    try{
      ...
      super.reportName="ACC_COMM_DISC.rpt";
    }catch(Exception exp){
       exp.printStackTrace();
    }
  }

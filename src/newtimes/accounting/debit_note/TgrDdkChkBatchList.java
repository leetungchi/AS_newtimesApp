...
public class TgrDdkChkBatchList extends CommandTrigger{
  public TgrDdkChkBatchList() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    ...
    javax.swing.JFrame jframe=processhandler.template.Properties.getMainFrame();
       ...
       PnlDdkChkBatchList  pnl=new PnlDdkChkBatchList();
       pnl.jbInit();
       processhandler.template.Properties.getSplitFrame().setPanel(
          pnl,
          tempDownPnl
        );
       processhandler.template.Properties.getSplitFrame().setDividerLocation(0.32);

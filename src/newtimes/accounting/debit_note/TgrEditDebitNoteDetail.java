...
public class TgrEditDebitNoteDetail extends CommandTrigger {

  public TgrEditDebitNoteDetail() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    try{
      ...
      PnlEditDebitNoteDetail pnl=new PnlEditDebitNoteDetail(null,null,null);
      pnl.setSize(800, 600);

...
public class PnlRptWithCommDtlList
    extends AbsQryPanel{
    //extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("DEBIT NOTE WITH COMM DETAIL LIST");
  ...
  try{
    ...
    Object chkDelDate = CellFormat.getDateStringFormaterAllowNull();
     ...
     super.reportName="ACC_DBINV_COMM.rpt";
   }catch(Exception exp){
      exp.printStackTrace();
   }
  }

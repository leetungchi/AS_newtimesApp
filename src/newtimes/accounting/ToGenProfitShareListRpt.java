...
public class ToGenProfitShareListRpt implements AbleToGenProfitShareListRpt{
  public ToGenProfitShareListRpt() {
  ...
  public void toGenProfitShareListRpt() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlProfitShareList  pnl=new PnlProfitShareList();
       pnl.jbInit();

...
public class TogenStatementOfTotalCommission implements AbleTogenStatementOfTotalCommission{
  public TogenStatementOfTotalCommission() {
  ...
  public void togenStatementOfTotalCommission() throws processhandler.commands.CommandException{
    ...
    try{
      ...
      System.out.println("is report engine ok ? "+
       ...
       PnlStatmentOfTotalCommission    pnl=new PnlStatmentOfTotalCommission();
       pnl.jbInit();

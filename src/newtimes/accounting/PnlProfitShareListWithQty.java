...
public class PnlProfitShareListWithQty
    //extends JPanel {
...
*/
 ...
 int indexOfMng=0;
  public PnlProfitShareListWithQty() {
    try {
      //jbInit();
    }
    catch(Exception ex) {
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("PROFIT SHARE WITH QTY");
   ...
   */
    ...
    */
    ...
    lblRptType.setText("REPORT:");
    lblRptType.setBounds(new Rectangle(532, 147, 60, 24));
    cbxRptType.setBounds(new Rectangle(598, 147, 168, 21));
  ...
  protected void genDataBindObj(){
    ...
    /*
     ...
     dataBindComps.add(dbHkdChg);
      ...
      this.add(cbxCountry, null);
      this.add(cbxRptType, null);
      reportName ="PROFIT_SHARE_QTY.rpt";
  ...
  void btnQry_actionPerformed(ActionEvent e) {
    ...
    if(cbxRptType.getSelectedIndex()==0){
      reportName ="PROFIT_SHARE_QTY.rpt";
    }else{
      reportName ="PROFIT_SHARE_QTY_SIMP.rpt";
    }
  ...
  JLabel lblRptType = new JLabel();
  JComboBox cbxRptType = new JComboBox(new String[]{"NT ALL","OVERSEAS"});
}

...
public class TgrListDDK4XLV extends CommandTrigger {
  String srn;
  PnlQryLocalVoucher pnlParent;
  public TgrListDDK4XLV(String _srn,PnlQryLocalVoucher _pnlParent) {
    srn=_srn;
  ...
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    try{
      ...
      PnlListDDK4XLV pnl=new PnlListDDK4XLV(srn,pnlParent);
      pnl.setSize(800, 600);

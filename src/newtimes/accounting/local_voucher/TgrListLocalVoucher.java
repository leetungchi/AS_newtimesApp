...
public class TgrListLocalVoucher extends CommandTrigger {
  static PnlQryLocalVoucher pnl=null;
  public TgrListLocalVoucher() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    try{
      ...
      if(pnl==null){
        pnl = new PnlQryLocalVoucher();
        pnl.HASHMAP_SRN_CHECKLIST.clear();
        pnl.HASHMAP_SRN_CHECKLIST_RECORDS.clear();

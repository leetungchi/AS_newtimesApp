...
public class PnlCommAmtList
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("COMMISION AMOUNT LIST");
    ...
    btnQry.addActionListener(new PnlCommAmtList_btnQry_actionAdapter(this));
    cbxDep.setBounds(new Rectangle(53, 77, 130, 22));
    txtDateBgn.setText("");
    txtDateBgn.setBounds(new Rectangle(52, 19, 87, 20));
    this.setBackground(new Color(202, 202, 224));
    cbxManager.setBounds(new Rectangle(549, 61, 131, 24));
    lblManager.setText("Manager");
    lblManager.setBounds(new Rectangle(495, 61, 54, 25));
...
class PnlCommAmtList_btnQry_actionAdapter implements java.awt.event.
  ActionListener {
PnlCommAmtList adaptee;

PnlCommAmtList_btnQry_actionAdapter(PnlCommAmtList adaptee) {

...
public class PnlSrnNoDtlList
 ...
 protected void jbInit() throws Exception {
    ...
    blueBkgWhiteCharLabel1.setText("SRN W/O DETAIL LIST");
...
class PnlSrnNoDtlList_btnQry_actionAdapter implements java.awt.event.
  ActionListener {
PnlSrnNoDtlList adaptee;

PnlSrnNoDtlList_btnQry_actionAdapter(PnlSrnNoDtlList adaptee) {

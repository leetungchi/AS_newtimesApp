...
public class BranchDataFactory implements PagedDataFactory {
...
//    (BasicMdlEJBs.BasicMaintainEJB.BasicMaintainEJB)util.ApplicationProperites.getProperties("basicMainEJB");
  private java.util.HashMap hm4Branch = null;

  public BranchDataFactory(java.util.HashMap hm) {
    hm4Branch = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vCenData = exgui2.CONST.BASIC_MAIN_EJB.getBranchList(startPosition, rowCounts, hm4Branch);
    return vCenData;
  }

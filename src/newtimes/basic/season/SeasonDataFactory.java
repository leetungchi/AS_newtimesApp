...
public class SeasonDataFactory implements PagedDataFactory {
...
//  (BasicMdlEJBs.BasicMaintainEJB.BasicMaintainEJB)util.ApplicationProperites.getProperties("basicMainEJB");
  private java.util.HashMap hm4Season = null;

  public SeasonDataFactory(java.util.HashMap hm) {
    hm4Season = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vData = exgui2.CONST.BASIC_MAIN_EJB.getSeasonList(startPosition, rowCounts, hm4Season);
    return vData;
  }

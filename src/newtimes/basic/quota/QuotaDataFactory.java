...
public class QuotaDataFactory implements PagedDataFactory {
  private java.util.HashMap hm4Qta = null;

  public QuotaDataFactory(java.util.HashMap hm) {
    hm4Qta = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vDepData = exgui2.CONST.BASIC_MAIN_EJB.getQuotaList(startPosition, rowCounts, hm4Qta);
    return vDepData;
  }

...
public class SizeDataFactory implements PagedDataFactory {
...
//  (BasicMdlEJBs.BasicMaintainEJB.BasicMaintainEJB)util.ApplicationProperites.getProperties("basicMainEJB");
  private java.util.HashMap hm4Size = null;

  public SizeDataFactory(java.util.HashMap hm) {
    hm4Size = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vDepData = exgui2.CONST.BASIC_MAIN_EJB.getSizeList(startPosition, rowCounts, hm4Size);
    return vDepData;
  }

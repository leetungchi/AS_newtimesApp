...
public class UnitDataFactory implements PagedDataFactory {
...
//  (BasicMdlEJBs.BasicMaintainEJB.BasicMaintainEJB)util.ApplicationProperites.getProperties("basicMainEJB");
  private java.util.HashMap hm4Unit = null;

  public UnitDataFactory(java.util.HashMap hm) {
    hm4Unit = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vDepData = exgui2.CONST.BASIC_MAIN_EJB.getUnitList(startPosition, rowCounts, hm4Unit);
    return vDepData;
  }

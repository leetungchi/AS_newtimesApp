...
public class UserDataFactory implements PagedDataFactory {
  private java.util.HashMap hm4Usr = null;

  public UserDataFactory(java.util.HashMap hm) {
    hm4Usr = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vDepData = exgui2.CONST.BASIC_BASE_EJB.getUserList(startPosition, rowCounts, hm4Usr);
    return vDepData;
  }

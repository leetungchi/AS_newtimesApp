...
public class CurrencyDataFactory implements PagedDataFactory {
...
//  (BasicMdlEJBs.BasicMaintainEJB.BasicMaintainEJB)util.ApplicationProperites.getProperties("basicMainEJB");
  private java.util.HashMap hm4Crncy = null;

  public CurrencyDataFactory(java.util.HashMap hm) {
    hm4Crncy = hm;
  }
  public Vector getRecords(int startPosition, int rowCounts) throws Exception {
    Vector vDepData = exgui2.CONST.BASIC_MAIN_EJB.getCurrencyList(startPosition, rowCounts, hm4Crncy);
    return vDepData;
  }

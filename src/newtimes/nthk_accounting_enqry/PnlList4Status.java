...
public class PnlList4Status extends AbstractUltraTablePanel {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
      try{
        if(e.getSource()==btnUpdate){
          ...
          ((newtimes.nthk_accounting_enqry.EnqDataEngin4Status)dbHandler).updatePoStatus(
  ...
  public PnlList4Status(EnqDataEngin pagedDataFxy,
      ...
      try{
        ...
        if(vctStatus==null){
          ...
          rec1.set(0,"1");
          rec1.set(1,"PENDING");vctStatus.add(rec1);

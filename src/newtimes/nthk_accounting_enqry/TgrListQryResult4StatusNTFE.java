...
public class TgrListQryResult4StatusNTFE extends TgrListQryResult {
  public TgrListQryResult4StatusNTFE(String p0) {
    super(p0);
  }
  protected void processForApprovalCancellation() throws processhandler.commands.CommandException{
    ...
    jframe.getContentPane().removeAll();
        ...
        */
        ...
        if(isToReload){
          EnqDataEngin dbShipMaster = new EnqDataEngin4StatusNTFE();
          pnl4AppvCancel =
              new PnlList4StatusNTFE(
              dbShipMaster, 15, iso,

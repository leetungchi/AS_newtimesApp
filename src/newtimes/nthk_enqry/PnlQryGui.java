...
public class PnlQryGui extends JPanel {
  ...
  public JButton btnQry = new JButton();
  ...
  public static boolean isFromProdEnqire=true;
  public PnlQryGui() {
    try {
...
protected  void jbInit() throws Exception {
    ...
    jLabel3.setBounds(new Rectangle(320, 60, 142, 32));
    jLabel3.setText("PO Details Enquiry");
    jLabel3.setFont(new java.awt.Font("Dialog", 1, 14));
    btnQry.setBounds(new Rectangle(289, 519, 135, 31));
    ...
    btnExit.setBounds(new Rectangle(613, 519, 88, 31));
    ...
    jLabel5.setBounds(new Rectangle(227, 125, 54, 25));
    jLabel5.setText("Dept. :");
    jLabel5.setFont(new java.awt.Font("Dialog", 0, 13));
    cbxDep.setBounds(new Rectangle(323, 125, 202, 22));
    jLabel6.setBounds(new Rectangle(227, 163, 81, 25));
    jLabel6.setText("Manager :");
    jLabel6.setFont(new java.awt.Font("Dialog", 0, 13));
    cbxMgrs.setBounds(new Rectangle(323, 163, 202, 22));
    jLabel7.setFont(new java.awt.Font("Dialog", 0, 13));
    jLabel7.setText("STYLE# :");
    jLabel7.setBounds(new Rectangle(227, 240, 81, 25));
    txtStyStyle.setBounds(new Rectangle(323, 240, 202, 22));
    jLabel9.setFont(new java.awt.Font("Dialog", 0, 13));
    jLabel9.setText("Customer:");
    jLabel9.setBounds(new Rectangle(227, 316, 80, 22));
    slkBuyer.setBounds(new Rectangle(323, 316, 202, 22));
    lblMaker.setBounds(new Rectangle(227, 355, 75, 22));
    lblMaker.setText("Vendor :");
    lblMaker.setFont(new java.awt.Font("Dialog", 0, 13));
    slkMaker.setBounds(new Rectangle(323, 355, 202, 22));
    lblEtdDlv.setFont(new java.awt.Font("Dialog", 0, 13));
    lblEtdDlv.setText("<html><body>Delivery<br>ETD</body></html>");
    lblEtdDlv.setBounds(new Rectangle(227, 429, 80, 38));
    txtEtdFrom.setText("");
    txtEtdFrom.setBounds(new Rectangle(341, 431, 80, 22));
    ...
    jLabel14.setText("PO# :");
    jLabel14.setBounds(new Rectangle(227, 278, 81, 25));
    txtStyPo.setBounds(new Rectangle(323, 278, 202, 22));
    txtScNo.setBounds(new Rectangle(323, 202, 202, 22));
    jLabel15.setBounds(new Rectangle(227, 202, 81, 25));
    ...
    btnQty4StatusUpdate.setBounds(new Rectangle(442, 519, 154, 31));
    ...
    slkVdr.setBounds(new Rectangle(323, 393, 202, 22));
    lblVdr.setFont(new java.awt.Font("Dialog", 0, 13));
    lblVdr.setText("Vendor :");
    lblVdr.setBounds(new Rectangle(227, 393, 75, 22));
    btnBrandBaseStatus.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
        btnBrandBaseStatus_actionPerformed(e);
      }
    });
    btnBrandBaseStatus.setText("EXTRACT");
    btnBrandBaseStatus.setActionCommand("GO!!");
    btnBrandBaseStatus.setFont(new java.awt.Font("Dialog", 1, 11));
    btnBrandBaseStatus.setBounds(new Rectangle(42, 519, 171, 31));
    this.add(jLabel1, null);
    this.add(jLabel3, null);
    this.add(jLabel2, null);
    this.add(jLabel4, null);
    this.add(cbxCntr, null);
    this.add(lblEtdDlv, null);
    ...
    this.add(slkVdr, null);
    this.add(lblVdr, null);
    ...
    btnBrandBaseStatus.setVisible(false);
    /*
    if(isFromProdEnqire){
      btnBrandBaseStatus.setVisible(false);
      btnQry.setVisible(true);
      btnQty4StatusUpdate.setVisible(true);

    }else{
      btnBrandBaseStatus.setVisible(true);
      btnQry.setVisible(false);
      btnQty4StatusUpdate.setVisible(false);
    }
    */
    ...
    slkVdr.init("CT_VENDER", null, slkBuyer.TYPE_VENDOR, true);
    guis.clear();
    ...
    public void itemStateChanged(ItemEvent e){
      ...
      try{
        ...
        if("NTHK".equals(util.PublicVariable.OPERATTING_CENTER)){
          slkVdr.setVisible(true);
          lblVdr.setVisible(true);
          lblVdr.setText("VENDOR");
          lblMaker.setText("MAKER");
        }else{
          slkVdr.setVisible(false);
          lblVdr.setVisible(false);
          lblMaker.setText("VENDOR");
        }
        slkBuyer.setSelectingCenter(util.PublicVariable.OPERATTING_CENTER);
        slkMaker.setSelectingCenter(util.PublicVariable.OPERATTING_CENTER);
          slkVdr.setSelectingCenter(util.PublicVariable.OPERATTING_CENTER);
  ...
  void btnExit_actionPerformed(ActionEvent e) {
    try{
      if(btnBrandBaseStatus.isVisible()){

        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
         ((newtimes.Frame1)util.PublicVariable.APP_FRAME).showPanel(new newtimes.shipping.ShippingMenu(
  ...
  private String initSelectionCriteria(){
    ...
    if(slkVdr.getSelectedValue()!=null){
      sb.append("  , Vendor :");
      sb.append(((javax.swing.JTextField)slkVdr.getGUIcomponent()).getText());
      itemCount++;
    }
  ...
  void btnQry_actionPerformed(ActionEvent e) {
    try{
      ...
      "newtimes.nthk_enqry.PnlListQryResult_TOP_RECORD_AT",
      new Integer(1));
      processhandler.template.Properties.getCenteralControler().doCommandExecute(
      new newtimes.nthk_enqry.TgrListQryResult(initSelectionCriteria()));
      //processhandler.template.Properties.getCenteralControler().goBack();
    }catch(Exception ie){
      ie.printStackTrace();
    }
  ...
  public JButton btnQty4StatusUpdate = new JButton();
  SelectBuyerMaker slkVdr = new SelectBuyerMaker();
  JLabel lblVdr = new JLabel();
  public JButton btnBrandBaseStatus = new JButton();//new JComboBox();
  void btnQty4StatusUpdate_actionPerformed(ActionEvent e) {
    try{
      ...
      if(util.PublicVariable.OPERATTING_CENTER.equals("NTFE")){
        processhandler.template.Properties.getCenteralControler().
            doCommandExecute(
            new newtimes.nthk_enqry.TgrListQryResult4StatusNTFE(
            initSelectionCriteria()));
      }else{
        processhandler.template.Properties.getCenteralControler().
            doCommandExecute(
            new newtimes.nthk_enqry.TgrListQryResult4Status(
            initSelectionCriteria()));
      }
    }catch(Exception ie){
      ie.printStackTrace();
  ...
  void btnBrandBaseStatus_actionPerformed(ActionEvent e) {
    ...
    Db4BrandBaseStatus.setReCondition(conditions);
    util.ApplicationProperites.setProperties(
    "newtimes.nthk_enqry.PnlListQryResult_TOP_RECORD_AT",
    new Integer(1));
    try{
       processhandler.template.Properties.getCenteralControler().doCommandExecute(
       new newtimes.nthk_enqry.TgrListBrandBaseStatus(null));
    }catch(Exception exp){
      exp.printStackTrace();

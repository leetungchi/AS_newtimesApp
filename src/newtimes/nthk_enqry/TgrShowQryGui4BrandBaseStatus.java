...
public class TgrShowQryGui4BrandBaseStatus extends CommandTrigger {
  public TgrShowQryGui4BrandBaseStatus() {
  }
  protected void activateThisProcess() throws processhandler.commands.CommandException {
    try{
      ...
      pnl.lblEtdDlv.setText("<html><body>Delivery<br>Date</body></html>");
      pnl.setSize(800, 600);
      pnl.slkBuyer.init("a.PROD_BUYER",new Integer(11108),pnl.slkBuyer.TYPE_BUYER,false);
      pnl.jLabel9.setVisible(false);
      pnl.slkBuyer.setVisible(false);
      pnl.btnBrandBaseStatus.setVisible(true);
      pnl.jLabel3.setText("PO STATUS");
      pnl.btnQry.setVisible(false);
      pnl.btnQty4StatusUpdate.setVisible(false);
